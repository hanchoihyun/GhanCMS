 ...
 */
/*
define('self::ZEBRA_IMAGE_BOXED', 0);
define('self::ZEBRA_IMAGE_NOT_BOXED', 1);
define('self::ZEBRA_IMAGE_CROP_TOPLEFT', 2);
define('self::ZEBRA_IMAGE_CROP_TOPCENTER', 3);
define('self::ZEBRA_IMAGE_CROP_TOPRIGHT', 4);
define('self::ZEBRA_IMAGE_CROP_MIDDLELEFT', 5);
define('self::ZEBRA_IMAGE_CROP_CENTER', 6);
define('self::ZEBRA_IMAGE_CROP_MIDDLERIGHT', 7);
define('self::ZEBRA_IMAGE_CROP_BOTTOMLEFT', 8);
define('self::ZEBRA_IMAGE_CROP_BOTTOMCENTER', 9);
define('self::ZEBRA_IMAGE_CROP_BOTTOMRIGHT', 10);
*/
 ...
 *  @package    Zebra_Image
 */
class Zebra_Image extends CApplicationComponent {

    const ZEBRA_IMAGE_BOXED = 0;
    const ZEBRA_IMAGE_NOT_BOXED = 1;
    const ZEBRA_IMAGE_CROP_TOPLEFT = 2;
    const ZEBRA_IMAGE_CROP_TOPCENTER = 3;
    const ZEBRA_IMAGE_CROP_TOPRIGHT = 4;
    const ZEBRA_IMAGE_CROP_MIDDLELEFT = 5;
    const ZEBRA_IMAGE_CROP_CENTER = 6;
    const ZEBRA_IMAGE_CROP_MIDDLERIGHT = 7;
    const ZEBRA_IMAGE_CROP_BOTTOMLEFT = 8 ;
    const ZEBRA_IMAGE_CROP_BOTTOMCENTER = 9;
    const ZEBRA_IMAGE_CROP_BOTTOMRIGHT = 10;
    /**
     ...
     *  $img->resize(150, 150, self::ZEBRA_IMAGE_CROP_CENTER);
     *  </code>
     *
     ...
     *
     *                                          -   <b>self::ZEBRA_IMAGE_BOXED</b> - the image will be scalled so that it will
     ...
     *
     *                                          -   <b>self::ZEBRA_IMAGE_NOT_BOXED</b> - the image will be scalled so that it
     ...
     *
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_TOPLEFT</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_TOPCENTER</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_TOPRIGHT</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_MIDDLELEFT</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_CENTER</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_MIDDLERIGHT</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_BOTTOMLEFT</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_BOTTOMCENTER</b>
     *                                          -   <b>self::ZEBRA_IMAGE_CROP_BOTTOMRIGHT</b>
     *
     ...
     *
     *                                          Default is self::ZEBRA_IMAGE_CROP_CENTER
     *
     ...
     *                                          wrong
     */
    public function resize($width = 0, $height = 0, $method = self::ZEBRA_IMAGE_CROP_CENTER, $background_color = '#FFFFFF') {
        ...
        if ($this->_create_from_source()) {
            ...
            if ($this->preserve_aspect_ratio || isset($auto_preserve_aspect_ratio)) {
                ...
                if ($width == 0 && $height > 0) {
                    ...
                    // if both width and height are given and self::ZEBRA_IMAGE_BOXED or self::ZEBRA_IMAGE_NOT_BOXED methods are to be used
            ...
            // all images are to be resized - including images that are smaller than the given width/height
                ...
                // aspect ratio needs to be preserved AND
                    ...
                    switch ($method) {
                        ...
                        case self::ZEBRA_IMAGE_CROP_TOPLEFT:
                        ...
                        case self::ZEBRA_IMAGE_CROP_TOPCENTER:
                        ...
                        case self::ZEBRA_IMAGE_CROP_TOPRIGHT:
                        ...
                        case self::ZEBRA_IMAGE_CROP_MIDDLELEFT:
                        ...
                        case self::ZEBRA_IMAGE_CROP_CENTER:
                        ...
                        case self::ZEBRA_IMAGE_CROP_MIDDLERIGHT:
                        ...
                        case self::ZEBRA_IMAGE_CROP_BOTTOMLEFT:
                        ...
                        case self::ZEBRA_IMAGE_CROP_BOTTOMCENTER:
                        ...
                        case self::ZEBRA_IMAGE_CROP_BOTTOMRIGHT:
                    ...
                    // it needs to be preserved and method is self::ZEBRA_IMAGE_BOXED or self::ZEBRA_IMAGE_NOT_BOXED
                } else {

                    // prepare the target image
                    $target_identifier = $this->_prepare_image(
                            ($width > 0 && $height > 0 && $method != self::ZEBRA_IMAGE_NOT_BOXED ? $width : $target_width), ($width > 0 && $height > 0 && $method != self::ZEBRA_IMAGE_NOT_BOXED ? $height : $target_height), $background_color
                    );

                    imagecopyresampled(
                            $target_identifier, $this->source_identifier, ($width > 0 && $height > 0 && $method != self::ZEBRA_IMAGE_NOT_BOXED ? ($width - $target_width) / 2 : 0), ($width > 0 && $height > 0 && $method != self::ZEBRA_IMAGE_NOT_BOXED ? ($height - $target_height) / 2 : 0), 0, 0, $target_width, $target_height, $this->source_width, $this->source_height
                    );
